...
translation check, Model 25.0 is the RTMB development line begun in 2025, and
Model 26.0 is the Rceattle development line begun in 2026. SPoRC provides a
supporting comparison across the development lines. The Data section also
separates two age-data questions: use of FT-NIRS predicted ages and revision of
...
the standard seven-alternative projection workflow. They serve as development
tests, while Model 23.0 provides the management recommendations. The exploratory recruitment
analysis favored the model containing age-0 late-summer sea-surface
temperature; its negative fitted pathway provides a testable in-sample
association for further biological and predictive evaluation. Model 23.0
continues to provide current management advice while Models 25.0 and 26.0
proceed through simulation testing and review. Appendix 1 preserves the SSC
comments and response plan, Appendix 2 provides the development framework for
an Ecosystem and Socioeconomic Profile, and Appendix 3 documents fishery
length-frequency patterns.
...
![Annual acoustic-trawl survey selectivity for Model 23.2 and Model 26.0, with each curve normalized to a maximum of one.](assets/model-26-0/model_23_2_vs_26_0_ats_selectivity.png){#fig-model-23-2-26-ats-selectivity fig-alt="Two tall side-by-side ridge plots compare relative acoustic-trawl survey selectivity at ages 1 through 15 for every year from 1994 through 2024. Model 23.2 is on the left in blue and Model 26.0 is on the right in green. Age 1 is zero in both models. Both models rise across younger ages and level across older ages, with visible age-specific differences between the panels." width="92%"}
