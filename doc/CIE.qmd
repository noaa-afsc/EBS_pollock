...
A commonly adopted approach  
is to use estimated natural mortality-at-age and year from
...
recruitment (@fig-Mmat-recruitment) lower spawning biomass in the near term (@fig-Mmat_ssb1 and @fig-Mmat_ssb2). 
