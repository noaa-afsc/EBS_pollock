...
```{r mod_fit_agg_comp}
library(kableExtra)
kbl(tab_ref(ftn_lst[2:4]), align = "cc", booktabs = TRUE, escape = FALSE) #|>
    #add_header_above(
    #header = setNames(c(1,2),
                      #c(" ", "something" )) ,
    #bold = TRUE) #|> pack_rows( names(dimnames(tbltext))[1] , 1, 2)
```
...
result in a relatively consistent estimate of the population size. 
