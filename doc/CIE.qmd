...
In the sixth section we evaluated some **alternative assessment platforms** [see @sec-altsoft], including SS3, SAM, Rceattle, 
...
The eighth section details **fishery selectivity parameterization** [see @sec-selnotes]. 
...
We concluded with some notes  that intended to address some **regularization and penalty terms** 
[see @sec-penalty]. These include penalties on deviation magnitude, smoothness, and temporal 
stability. Collectively they help prevent overfitting, enforce smooth selectivity patterns, 
and constrain abrupt year-to-year changes. Their influence on stability of model fits and 
interpretability of selectivity is emphasized.

Overall, the analyses underscore three key points:

1. *Data dependence:* The BTS survey remains the critical data source, with model outcomes highly sensitive to its inclusion.  
2. *Emerging methods:* FT-NIR ageing, multi-species mortality, and model-based survey products hold promise but require careful validation.  
