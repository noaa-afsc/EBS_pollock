...
@fig-synts shows the model results comparing the last year's model some
alternative model platforms.
In @fig-synts, comparing the SS3 output with three different configurations on selectivity constraint
shows similarities in the time series.
