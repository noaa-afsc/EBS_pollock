...
plot_agefit(modlst[[3]],case_label=names(modlst)[3],gear="ats","Acoustic survey")
...
proportions <- data.frame(modlst[[1]]$pobs_bts)
...
#| fig.cap: "Model results comparing last year's selected model -2021)"
# Set working directory & plot save directory
proportions <- data.frame(modlst[[1]]$pobs_ats)
