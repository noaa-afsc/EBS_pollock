...
lab and the University of Alaska, Fairbanks (@spock). 
...
#library(plotly)
p1 <- ggplotly(Plot_SSB(all_ts) + ggthemes::theme_few(base_size = 19))
htmlwidgets::saveWidget(p1, "plot1.html", selfcontained = TRUE)
